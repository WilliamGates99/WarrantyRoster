...
plugins {
    id("com.android.application") version "7.4.1" apply false // Android Gradle Plugin Version
    id("com.android.library") version "7.4.1" apply false // Android Gradle Plugin Version
