...
plugins {
    id("com.android.application") version "8.0.1" apply false // Android Gradle Plugin Version
    id("com.android.library") version "8.0.1" apply false // Android Gradle Plugin Version
