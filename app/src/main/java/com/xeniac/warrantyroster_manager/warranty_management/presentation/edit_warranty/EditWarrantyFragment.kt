...
@AndroidEntryPoint
class EditWarrantyFragment @Inject constructor(
    private val imageLoader: ImageLoader,
    private val decimalFormat: DecimalFormat,
    private val dateFormat: SimpleDateFormat,
    var viewModel: EditWarrantyViewModel? = null
) : Fragment(R.layout.fragment_edit_warranty) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = viewModel
            ?: ViewModelProvider(requireActivity())[EditWarrantyViewModel::class.java]
    ...
    private fun setWarrantyDetails() {
        binding.apply {
            ...
            warranty.categoryId?.let {
                selectedCategory = getCategoryById(it)
                selectedCategory?.let { category ->
                    tiDdCategory.setText(category.title[getCategoryTitleMapKey()])
                    loadCategoryIcon(category.icon)
                }
            }
