...
fun LoginWithXError.asUiText(): UiText = when (this) {
    ...
    LoginWithXError.Network.FirebaseAuthInvalidUserException -> UiText.StringResource(R.string.auth_method_google_error_account_not_exist)
    LoginWithXError.Network.FirebaseAuthInvalidCredentialsException -> UiText.StringResource(R.string.auth_method_google_error_corrupted_or_expired_credential)
    LoginWithXError.Network.FirebaseAuthUserCollisionException -> UiText.StringResource(R.string.auth_method_google_error_email_exists_with_different_credentials)
