...
import com.xeniac.warrantyroster_manager.feature_auth.common.data.repositories.LoginWithFacebookRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @ViewModelScoped
    abstract fun bindLoginWithFacebookRepository(
        loginWithFacebookRepositoryImpl: LoginWithFacebookRepositoryImpl
