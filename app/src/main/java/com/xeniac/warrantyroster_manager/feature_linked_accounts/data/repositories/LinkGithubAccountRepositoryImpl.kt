...
class LinkGithubAccountRepositoryImpl @Inject constructor(
    ...
    override suspend fun linkGithubAccount(
        ...
        return try {
            ...
            e.printStackTrace()
            when {
                isFirebaseCancellationException(e.message) -> Result.Error(LinkGithubAccountError.CancellationException)
                isAnotherAuthOperationInProgress(e.message) -> Result.Error(LinkGithubAccountError.AnotherOperationIsInProgress)
